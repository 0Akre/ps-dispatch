...
function addNewCall(callID, timer, info, isPolice) {
	...
	let DispatchItem;
	if (info['isDead']) {
        DispatchItem = `<div class="dispatch-item ${callID} dispatch-item-${isPolice} animate__animated"><div class="dispatch-item priority-${prio}"> <div class="top-info-holder"><div class="call-id">#${callID}</div><div class="call-code">${info.dispatchCode}</div><div class="call-name">${info.dispatchMessage}</div></div><div class="bottom-info-holder">`
	} else {
		DispatchItem = `<div class="dispatch-item ${callID} dispatch-item-${isPolice} animate__animated"><div class="dispatch-item priority-${prio}"> <div class="top-info-holder"><div class="call-id">#${callID}</div><div class="call-code">${info.dispatchCode}</div><div class="call-name">${info.dispatchMessage}</div></div><div class="bottom-info-holder">`;
	}
